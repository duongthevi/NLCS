package com.dtvi.Pet.Ecommerce.mapper;

import com.dtvi.Pet.Ecommerce.dto.*;
import com.dtvi.Pet.Ecommerce.entity.*;
...
public class EntityDtoMapper {
    ...
    public BestSellingProductDto mapBestSellingProduct(Object[] productData) {
        BestSellingProductDto dto = new BestSellingProductDto();
        dto.setProductId((Long) productData[0]); 
        dto.setProductName((String) productData[1]); 
        dto.setTotalQuantity((Long) productData[2]); 
        return dto;
    }
}
